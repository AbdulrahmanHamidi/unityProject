...
namespace Leap.Unity.Examples {
  ...
  public class TransformTool : MonoBehaviour
  {
    ...
    //private GameObject StatusLight = GameObject.Find("StatusLight").gameObject;
    ...
    private void onPostPhysics() {
     ...
     // Debug.Log(target.transform.position);
      ...
      {
        GameObject.Find("StatusLight").gameObject.GetComponent<Light>().color = Color.red;
        //StatusLight.GetComponent<Light>().color = Color.red;
      }
      else
      {
        GameObject.Find("StatusLight").gameObject.GetComponent<Light>().color = Color.white;
      }
    ...
    public void NotifyHandleDeactivated(TransformHandle handle) {
     ...
     //EDITED CODE
      ManagerScript.Instance.MakeItLastTouched(target.parent.name);
    }
